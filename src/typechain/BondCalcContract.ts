...
export interface BondCalcContractInterface extends ethers.utils.Interface {
  functions: {
...
export interface BondCalcContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BondCalcContractInterface;
